    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="flex md:hidden flex-col gap-2">
          {/* Row 1: Brand Logo + Language Switcher + Menu */}
          <div className="flex items-center justify-between gap-2">
            <button
              onClick={() => handleNavClick('home')}
              id="mobile-brand-logo"
              className="group flex items-center focus:outline-none rounded-lg text-start cursor-pointer"
            >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <div className="relative">
                <button
                  onClick={() => setLangDropdownOpen(!langDropdownOpen)}
                  className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-slate-900/90 border border-white/10 text-slate-200 text-xs font-semibold"
                >
                  <Globe className="w-3.5 h-3.5 text-cyan-400" />
                ...
                {langDropdownOpen && (
                  <div className="absolute top-full mt-2 end-0 w-36 py-1 rounded-xl bg-slate-900 border border-white/15 shadow-2xl z-50">
                    {languages.map((lang) => (
                      <button
                        key={lang.code}
                        onClick={() => {
                        ...
                        className={`w-full flex items-center justify-between px-3 py-2 text-xs text-start ${
                          currentLang === lang.code
              ...
              {/* Extra Pages Menu (Reviews, Why Us, Home) */}
              <div className="relative">
                <button
                ...
                {extraMenuOpen && (
                  <div
                    ...
                    className="absolute top-full mt-2 end-0 w-48 py-2 rounded-2xl bg-slate-900/98 border border-white/15 backdrop-blur-2xl shadow-2xl z-50 text-start"
                  >
                    <button
                      onClick={() => handleNavClick('home')}
